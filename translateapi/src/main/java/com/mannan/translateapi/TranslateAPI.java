...
public class TranslateAPI {
    ...
    private static final String  valueRequestProperty = "Mozilla/5.0";
    private static final String  NetworkError = "Network Error";
    private static final String  InvalidInputString = "Invalid Input String";
    ...
    class Async extends AsyncTask<String,String,String>{
        ...
        protected String doInBackground(String... strings) {
            try {
                ...
                con.setRequestProperty(keyRequestProperty, valueRequestProperty);
        ...
        protected void onPostExecute(String s) {
            ...
            if(resp==null){listener.onFailure(NetworkError);}else {
            try {
                ...
                }else {listener.onFailure(InvalidInputString);}

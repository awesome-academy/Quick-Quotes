...
class AuthorActivityPresenter(
    ...
    ): AuthorActivityContract.Persenter{

    private var mView : AuthorActivityContract.View? = null

    override fun onStart() {}

    override fun onStop() {}

    override fun setView(view: AuthorActivityContract.View?) {
        this.mView = view
    }

    override fun getListAuthorFromAPI(key : String) {
        ...
        mRepoQuotes.getApiQuotesWithAuthor(key, object: OnRemoteResultListener<List<Quotes>>{
